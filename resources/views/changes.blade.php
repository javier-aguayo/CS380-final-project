...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#Lorem_ipsum_dolor_sit_amet_Con_dg {
		position: absolute;
		left: 232px;
		top: 17px;
		overflow: visible;
	...
	#button_next {
		transform: matrix(1,0,0,1,812.5,655.5) rotate(90deg);
		transform-origin: center;
		position: absolute;
		width: 28px;
		height: 27px;
...
<div id="Changes">
	...
	<div id="Group_14">
		...
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_Group_1_ed_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_Group_1_ed" id="Mask_Group_1_ed_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_Group_1_ed_pattern.png" xlink:href="Mask_Group_1_ed_pattern.png"></image>
				</pattern>
				</svg>
			</div>
		<div id="Arya_Stark">
		...
		<div id="Group_297">
			...
			<div id="Group_190">
				<svg class="Rectangle_1498">
					<rect fill="rgba(255,255,255,1)" stroke="rgba(245,60,86,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1498" rx="5" ry="5" x="0" y="0" width="80" height="35">
					</rect>
				</svg>
				<div id="Closed">
					<span>Closed</span>
			...
			<div id="Group_313">
				<div id="Group_193">
					<svg class="Rectangle_1489_ci">
						<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ci" rx="5" ry="5" x="0" y="0" width="198" height="50">
						</rect>
					</svg>
					<div id="Consectetur">
	...
	<div id="Group_307">
		<svg class="Rectangle_1530">
			<rect fill="rgba(255,255,255,1)" id="Rectangle_1530" rx="10" ry="10" x="0" y="0" width="956" height="279">
			</rect>
		</svg>
			...
			<div id="Table">
				<div id="row_invoice">
					<div id="row_invoice_c">
						...
						<div id="Some_Change_c">
							<span>Some Change</span>
						</div>
						<div id="Consectetur_da">
							<span>Consectetur</span>
						</div>
					</div>
					<div id="row_invoice_db">
						<svg class="Divider_dc">
							<rect fill="rgba(241,241,243,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Divider_dc" rx="0" ry="0" x="0" y="0" width="1078.96" height="1">
							</rect>
						</svg>
						<svg class="Row_BG_dd" viewBox="0 0 1078.96 50">
							<path fill="rgba(255,255,255,1)" id="Row_BG_dd" d="M 0 0 L 794.535400390625 0 L 1078.96044921875 0 L 1078.96044921875 50 L 0 50 L 0 0 Z">
							</path>
						</svg>
						<div id="ID8_31_2020">
							<span>8/31/2020</span>
						...
						<div id="Lorem_ipsum_dolor_sit_amet_Con_dg">
							<span>Lorem ipsum dolor sit amet Consectetur</span>
						</div>
						<div id="ID2">
							<span>2</span>
						</div>
						<div id="Some_Change_di">
							<span>Some Change</span>
						</div>
						<div id="Consectetur_dj">
							<span>Consectetur</span>
						</div>
					</div>
					<div id="row_invoice_dk">
						...
						<div id="Some_Change_dr">
							<span>Some Change</span>
						</div>
						<div id="Consectetur_ds">
							<span>Consectetur</span>
						</div>
					</div>
				</div>
				<div id="Head">
					<svg class="Head_BG">
						<rect fill="rgba(245,246,250,1)" id="Head_BG" rx="0" ry="0" x="0" y="0" width="906" height="45">
						</rect>
					</svg>
					<div id="Status">
						<span>Status</span>
					</div>
					<div id="Description_dw">
						<span>Description</span>
					</div>
					<div id="__dx">
						<span>#</span>
	...
	<div id="Group_329">
		<div id="Group_193_d">
			<svg class="Rectangle_1489_d">
				<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_d" rx="5" ry="5" x="0" y="0" width="96" height="50">
				</rect>
			</svg>
			<div id="Closed_d">
				<span>Closed</span>
