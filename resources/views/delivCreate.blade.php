...
<title>Deliverable Create</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Deliverable Create;
		--web-view-id: Deliverable_Create;
	...
	:root {
		--web-view-ids: Deliverable_Create;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Lorem_ipsum_dolor_sit_amet_Con_dx {
		position: absolute;
		left: 355px;
		top: 17px;
		overflow: visible;
...
<div id="Deliverable_Create">
	...
	<div id="Scroll_Bar">
		<div id="Component_69___6" class="Component_69___6">
		...
		<div id="button_next" class="button_next">
			<svg class="Rectangle_156_cb">
				<rect fill="rgba(255,255,255,1)" stroke="rgba(232,233,236,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_156_cb" rx="4" ry="4" x="0" y="0" width="35" height="35">
				</rect>
			</svg>
			<svg class="Path_294_cc" viewBox="1803.616 4362.342 7.57 12.934">
				<path fill="transparent" stroke="rgba(136,152,170,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Path_294_cc" d="M 1803.61572265625 4362.341796875 C 1803.61572265625 4362.341796875 1811.185791015625 4369.0732421875 1811.185791015625 4369.0732421875 C 1811.185791015625 4369.0732421875 1803.61572265625 4375.275390625 1803.61572265625 4375.275390625">
				</path>
			</svg>
		</div>
	</div>
	<div id="Group_306">
		<div id="Group_297">
			...
			<div id="Group_303">
				<div id="Group_193">
					<svg class="Rectangle_1489_cs">
						<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_cs" rx="5" ry="5" x="0" y="0" width="77" height="50">
						</rect>
					</svg>
					<div id="ID9_15_20">
						<span>9/15/20</span>
		...
		<div id="Group_301">
			<div id="Group_198">
				<svg class="Rectangle_1489_cx">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_cx" rx="5" ry="5" x="0" y="0" width="670" height="100">
					</rect>
				</svg>
	...
	<div id="Group_307">
			...
			<div id="Table">
				<div id="row_invoice">
					...
					<div id="row_invoice_dk">
						...
						<div id="Some_Deliverable_dr">
							<span>Some Deliverable</span>
						</div>
					</div>
					<div id="row_invoice_ds">
						<svg class="Divider_dt">
							<rect fill="rgba(241,241,243,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Divider_dt" rx="0" ry="0" x="0" y="0" width="1078.96" height="1">
							</rect>
						</svg>
						<svg class="Row_BG_du" viewBox="0 0 1078.96 50">
							<path fill="rgba(255,255,255,1)" id="Row_BG_du" d="M 0 0 L 794.535400390625 0 L 1078.96044921875 0 L 1078.96044921875 50 L 0 50 L 0 0 Z">
							</path>
						</svg>
						<div id="ID9_15_2020">
							<span>9/15/2020</span>
						...
						<div id="Lorem_ipsum_dolor_sit_amet_Con_dx">
							<span>Lorem ipsum dolor sit amet Consectetur</span>
						</div>
						<div id="ID3">
							<span>3</span>
						</div>
						<div id="Some_Deliverable_dz">
							<span>Some Deliverable</span>
						</div>
					</div>
				</div>
				<div id="Head">
					<svg class="Head_BG">
						<rect fill="rgba(245,246,250,1)" id="Head_BG" rx="0" ry="0" x="0" y="0" width="1079" height="45">
						</rect>
					</svg>
					<div id="Due_Date_d">
						<span>Due Date</span>
		...
		<div id="Deliverables_ea">
			<span>Deliverables</span>
		</div>
	</div>
	<div id="Group_308">
		<div id="Group_297_ec">
			<svg class="Rectangle_1497_ed">
				<rect fill="rgba(255,255,255,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1497_ed" rx="10" ry="10" x="0" y="0" width="858" height="510">
				</rect>
			</svg>
			<div id="Create_Deliverable">
				<span>Create Deliverable</span>
			</div>
			<svg class="Line_41_ef" viewBox="0 0 857.5 1">
				<path fill="transparent" id="Line_41_ef" d="M 0 0 L 857.5 0">
				</path>
			</svg>
			<div id="Group_303_eg">
				<div id="Group_193_eh">
					<svg class="Rectangle_1489_ei">
						<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ei" rx="5" ry="5" x="0" y="0" width="77" height="42">
						</rect>
					</svg>
					Due Date
					<div id="Due_Date_ej">
		...
		<div id="Group_301_ek">
			<div id="Group_198_el">
				<svg class="Rectangle_1489_em">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_em" rx="5" ry="5" x="0" y="0" width="788" height="100">
					</rect>
				</svg>
	...
	<div id="Group_309">
		<div id="Group_198_ep">
			<svg class="Rectangle_1489_eq">
				<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_eq" rx="5" ry="5" x="0" y="0" width="670" height="100">
				</rect>
			</svg>
			<div id="Add_requirements_">
				<span>Add requirements…   <input type="text" name="title" placeholder="Enter a Title…" value="New Requirement"> <br>
					<input type="checkbox" name="1" value="Task1"> Requirement 1 <br>
					<input type="checkbox" name="2" value="Task2"> Requirement 2 <br>
					<input type="checkbox" name="1" value="Task1"> Requirement 3
				</span>
			</div>
		</div>
		<div id="Group_300_es">
			<div id="Group_22_et">
				<button onclick="alert('This Deliverable has been created')">
				<a href="/deliverables">
				<svg class="Rectangle_1498_eu">
					<rect fill="rgba(119,100,228,1)" id="Rectangle_1498_eu" rx="5" ry="5" x="0" y="0" width="100" height="45">
					</rect>
				</svg>
				<div id="Create">
					<span>Create</span>
			...
			<div id="Group_23_ew">
				<button onclick="alert('This Deliverable has been CANCELED')">
				<a href="/deliverables">
				<svg class="Rectangle_1498_ex">
					<rect fill="rgba(255,255,255,1)" stroke="rgba(245,60,86,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1498_ex" rx="5" ry="5" x="0" y="0" width="100" height="45">
					</rect>
				</svg>
				<div id="Cancel">
					<span>Cancel</span>
	...
	<div id="Group_310">
		<div id="Group_193_e">
			<svg class="Rectangle_1489_e">
				<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_e" rx="5" ry="5" x="0" y="0" width="320" height="42">
				</rect>
			</svg>
