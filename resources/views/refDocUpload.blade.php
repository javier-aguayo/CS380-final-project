...
<title>Reference Document Upload</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Reference Document Upload;
		--web-view-id: Reference_Document_Upload;
	...
	:root {
		--web-view-ids: Reference_Document_Upload;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#File_Name___jpg___png___docx__ {
		position: absolute;
		left: 24px;
		top: 14.458px;
		overflow: visible;
...
<body>
<div id="Reference_Document_Upload">
	...
	<div id="Group_14">
		...
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_Group_1_ep_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_Group_1_ep" id="Mask_Group_1_ep_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_Group_1_ep_pattern.png" xlink:href="Mask_Group_1_ep_pattern.png"></image>
				</pattern>
				</svg>
			</div>
		<div id="Arya_Stark">
			...
			<div id="Group_302">
				<div id="Group_4">
					<svg class="Rectangle_1489">
						<rect fill="rgba(255,255,255,1)" stroke="rgba(119,100,228,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1489" rx="5" ry="5" x="0" y="0" width="702" height="42">
						</rect>
					</svg>
	...
	<div id="Group_318">
		...
		<div id="button_normal" class="button_normal">
			<svg class="Rectangle_166">
				<rect fill="rgba(119,100,228,1)" stroke="rgba(119,100,228,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_166" rx="4" ry="4" x="0" y="0" width="83" height="35">
				</rect>
			</svg>
			<div id="Upload__">
				<span>Upload +</span>
	...
	<div id="Group_336">
		<div id="Group_332">
			<div id="Group_297_d">
				<svg class="Rectangle_1497_d">
					<rect fill="rgba(255,255,255,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1497_d" rx="10" ry="10" x="0" y="0" width="858" height="288">
					</rect>
				</svg>
				<div id="Upload_Document">
					<span>Upload Document</span>
				</div>
				<svg class="Line_41_d" viewBox="0 0 857.5 1">
					<path fill="transparent" id="Line_41_d" d="M 0 0 L 857.5 0">
					</path>
				</svg>
			</div>
		</div>
		...
		<div id="Group_334">
			<div id="Group_193">
				<svg class="Rectangle_1489_eg">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_eg" rx="5" ry="5" x="0" y="0" width="796" height="42">
					</rect>
				</svg>
		...
		<div id="Group_335">
			<div id="Group_193_ej">
				<svg class="Rectangle_1489_ek">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ek" rx="5" ry="5" x="0" y="0" width="796" height="42">
					</rect>
				</svg>
		...
		<div id="button_normal_em" class="button_normal">
			<svg class="Rectangle_166_en">
				<rect fill="transparent" stroke="rgba(119,100,228,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_166_en" rx="4" ry="4" x="0" y="0" width="99" height="45">
				</rect>
			</svg>
			<div id="Browse">
				<span>Browse</span>
