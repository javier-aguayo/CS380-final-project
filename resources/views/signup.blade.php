...
<div id="Signup">
	...
	<svg class="Rectangle_1488">
		<rect fill="rgba(247,250,252,1)" id="Rectangle_1488" rx="10" ry="10" x="0" y="0" width="476" height="553">
		</rect>
	</svg>
	<div id="Hey_there__Let_s_get_started_">
		<span>Hey there! Let's get started.</span>
	</div>
	<div id="Group_1">
		...
		<div id="I_agree_with_Privacy_Policy">
			<span>I agree with </span><span style="color:rgba(17,205,239,1);">Privacy Policy</span>
		</div>
	</div>
	<div id="Group_2">
	...
	<div id="button_normal" class="button_normal">
		<svg class="Rectangle_166">
			<rect fill="rgba(17,205,239,1)" id="Rectangle_166" rx="4" ry="4" x="0" y="0" width="130" height="50">
			</rect>
		</svg>
		<div id="Sign_up">
			<span>Sign up</span>
	...
	<div id="Project_Management_System">
		<span>Project Management System</span>
	</div>
	<div id="Existing_User__Login">
		<span>Existing User? </span><span style="font-style:normal;font-weight:normal;color:rgba(17,205,239,1);">Login</span>
	</div>
	<div id="Group_4">
		<svg class="Rectangle_1489_bw">
			<rect fill="rgba(255,255,255,1)" id="Rectangle_1489_bw" rx="5" ry="5" x="0" y="0" width="400" height="50">
			</rect>
		</svg>
		<div id="Name">
			<span>Name</span>
		...
		<div id="user" class="user">
			<svg class="Path_444" viewBox="4 15 16 6">
				<path fill="transparent" stroke="rgba(23,43,77,1)" stroke-width="2px" stroke-linejoin="round" stroke-linecap="round" stroke-miterlimit="4" shape-rendering="auto" id="Path_444" d="M 20 21 L 20 19 C 20 16.79086112976074 18.20913887023926 15 16 15 L 8 15 C 5.790861129760742 15 3.999999523162842 16.79086112976074 4 19 L 4 21">
				</path>
			</svg>
			<svg class="Ellipse_340">
				<ellipse fill="transparent" stroke="rgba(23,43,77,1)" stroke-width="2px" stroke-linejoin="round" stroke-linecap="round" stroke-miterlimit="4" shape-rendering="auto" id="Ellipse_340" rx="4" ry="4" cx="4" cy="4">
				</ellipse>
			</svg>
		</div>
	</div>
	<div id="Password_Strength__Strong">
		<span>Password Strength: </span><span style="font-style:normal;font-weight:bold;color:rgba(45,206,170,1);">Strong</span>
	</div>
</div>
</body>
</html>