...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#Excepteur_sint_occaecat_cupida_ct {
		position: absolute;
		left: 292px;
		top: 16px;
		overflow: visible;
	...
	#Excepteur_sint_occaecat_cupida_c {
		position: absolute;
		left: 292px;
		top: 16px;
		overflow: visible;
	...
	#Excepteur_sint_occaecat_cupida_da {
		position: absolute;
		left: 292px;
		top: 16px;
		overflow: visible;
	...
	#Excepteur_sint_occaecat_cupida_de {
		position: absolute;
		left: 292px;
		top: 16px;
		overflow: visible;
...
<div id="Requirements">
	...
	<div id="Group_14">
		...
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_Group_1_eb_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_Group_1_eb" id="Mask_Group_1_eb_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_Group_1_eb_pattern.png" xlink:href="Mask_Group_1_eb_pattern.png"></image>
				</pattern>
				</svg>
			</div>
		<div id="Arya_Stark">
	...
	<div id="Group_323">
		<div id="Referrer">
			<div id="Show_More_Link_cb">
				<span>Show More</span>
			</div>
			<div id="Requirements_cc">
				<span>Requirements</span>
			</div>
		</div>
		<div id="Req_list">
			<div id="Table">
				<div id="row_invoice">
					...
					<div id="row_invoice_cn">
						<svg class="Divider_co">
							<rect fill="rgba(241,241,243,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Divider_co" rx="0" ry="0" x="0" y="0" width="1078.96" height="1">
							</rect>
						</svg>
						<svg class="Row_BG_cp" viewBox="0 0 1078.96 50">
							<path fill="rgba(255,255,255,1)" id="Row_BG_cp" d="M 0 0 L 794.535400390625 0 L 1078.96044921875 0 L 1078.96044921875 50 L 0 50 L 0 0 Z">
							</path>
						</svg>
						<div id="ID8_31_2020">
							<span>8/31/2020</span>
						...
						<div id="Some_Requirement_cs">
							<span>Some Requirement</span>
						</div>
						<div id="Excepteur_sint_occaecat_cupida_ct">
							<span>Excepteur sint occaecat cupidatat non proident…</span>
						</div>
					</div>
					<div id="row_invoice_cu">
						<svg class="Divider_cv">
							<rect fill="rgba(241,241,243,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Divider_cv" rx="0" ry="0" x="0" y="0" width="1078.96" height="1">
							</rect>
						</svg>
						<svg class="Row_BG_cw" viewBox="0 0 1078.96 50">
							<path fill="rgba(255,255,255,1)" id="Row_BG_cw" d="M 0 0 L 794.535400390625 0 L 1078.96044921875 0 L 1078.96044921875 50 L 0 50 L 0 0 Z">
							</path>
						</svg>
						<div id="ID9_15_2020">
							<span>9/15/2020</span>
					...
					<div id="row_invoice_c">
						...
						<div id="Some_Requirement_c">
							<span>Some Requirement</span>
						</div>
						<div id="Excepteur_sint_occaecat_cupida_da">
							<span>Excepteur sint occaecat cupidatat non proident…</span>
						</div>
					</div>
					<div id="row_invoice_da">
						...
						<div id="Some_Requirement_dd">
							<span>Some Requirement</span>
						</div>
						<div id="Excepteur_sint_occaecat_cupida_de">
							<span>Excepteur sint occaecat cupidatat non proident…</span>
						</div>
					</div>
				</div>
	...
	<div id="Some_Requirement_dq">
		<span>Some Requirement</span>
	</div>
	<div id="Title_dr">
		<span>Title</span>
	</div>
	<svg class="Rectangle_1498_ds">
		<rect fill="rgba(119,100,228,1)" id="Rectangle_1498_ds" rx="5" ry="5" x="0" y="0" width="100" height="45">
		</rect>
	</svg>
	<div id="Update">
		<span>Update</span>
	</div>
	<svg class="Rectangle_1498_du">
		<rect fill="rgba(255,255,255,1)" stroke="rgba(245,60,86,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1498_du" rx="5" ry="5" x="0" y="0" width="100" height="45">
		</rect>
	</svg>
	<div id="Delete">
		<span>Delete</span>
	</div>
	<svg class="Rectangle_1489_dw">
		<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_dw" rx="5" ry="5" x="0" y="0" width="335" height="50">
		</rect>
	</svg>
	<div id="Location_in_Source_Document">
		<span>Location in Source Document</span>
	</div>
	<div id="Excepteur_sint_occaecat_">
		<span>Excepteur sint occaecat…</span>
	</div>
	<svg class="Rectangle_1489_dz">
		<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_dz" rx="5" ry="5" x="0" y="0" width="423" height="50">
		</rect>
	</svg>
	<div id="Excepteur_sint_occaecat_cupida_d">
		<span>Excepteur sint occaecat cupidatat non proident…</span>
	</div>
	<div id="Requirement_Description">
		<span>Requirement Description</span>
	</div>
	<svg class="Rectangle_1546">
		<rect fill="rgba(247,250,252,1)" id="Rectangle_1546" rx="5" ry="5" x="0" y="0" width="301" height="50">
		</rect>
	</svg>
	<div id="Source_Document">
		<span>Source Document</span>
	</div>
	<div id="Some_Document">
		<span>Some Document</span>
	</div>
	<svg class="Rectangle_1547">
		<rect fill="rgba(247,250,252,1)" id="Rectangle_1547" rx="5" ry="5" x="0" y="0" width="335" height="50">
		</rect>
	</svg>
	<div id="Related_Deliverable">
		<span>Related Deliverable</span>
	</div>
	<div id="Some_Deliverable">
		<span>Some Deliverable</span>
	</div>
	<svg class="Rectangle_1548">
		<rect fill="rgba(247,250,252,1)" id="Rectangle_1548" rx="5" ry="5" x="0" y="0" width="301" height="50">
		</rect>
	</svg>
	<div id="Client_Reference">
		<span>Client Reference</span>
	</div>
	<div id="Excepteur_sint_occaecat__ea">
		<span>Excepteur sint occaecat…</span>
	</div>
</div>
</body>
