...
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Task Create;
		--web-view-id: Task_Create;
...
<div id="Task_Create">
	...
	<div id="Scroll_Bar">
		<div id="Component_69___8" class="Component_69___8">
	...
	<div id="Group_324">
		<svg class="Rectangle_1497_ec">
			<rect fill="rgba(255,255,255,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1497_ec" rx="10" ry="10" x="0" y="0" width="858" height="510">
			</rect>
		</svg>
		<div id="Create_Task">
			<span>Create Task</span>
		</div>
		<svg class="Line_41_ee" viewBox="0 0 857.5 1">
			<path fill="transparent" id="Line_41_ee" d="M 0 0 L 857.5 0">
			</path>
		</svg>
		<div id="Group_303_ef">
			<div id="Group_193_eg">
				<svg class="Rectangle_1489_eh">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_eh" rx="5" ry="5" x="0" y="0" width="182" height="42">
					</rect>
				</svg>
		...
		<div id="Group_301_er">
			<div id="Group_198_es">
				<svg class="Rectangle_1489_et">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_et" rx="5" ry="5" x="0" y="0" width="788" height="100">
					</rect>
				</svg>
		...
		<svg class="Rectangle_1489_ev">
			<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ev" rx="5" ry="5" x="0" y="0" width="783" height="44">
			</rect>
		</svg>
		<div id="Group_22_ew">
		...
		<div id="Group_193_fa">
			<svg class="Rectangle_1489_fa">
				<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_fa" rx="5" ry="5" x="0" y="0" width="320" height="42">
				</rect>
			</svg>
