...
<title>Issue Create</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Issue Create;
		--web-view-id: Issue_Create;
...
<div id="Issue_Create">
	...
	<div id="Group_14">
		...
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_Group_1_fo_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_Group_1_fo" id="Mask_Group_1_fo_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_Group_1_fo_pattern.png" xlink:href="Mask_Group_1_fo_pattern.png"></image>
				</pattern>
				</svg>
			</div>
		<div id="Arya_Stark">
	...
	<div id="Group_171">
		<svg class="Rectangle_1490">
			<rect fill="rgba(31,31,31,1)" id="Rectangle_1490" rx="0" ry="0" x="0" y="0" width="65" height="1666">
			</rect>
		</svg>
		...
		<div id="Group_313">
			<div id="Group_193">
				<svg class="Rectangle_1489_ch">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ch" rx="5" ry="5" x="0" y="0" width="198" height="50">
					</rect>
				</svg>
				<div id="Consectetur">
				...
				<div id="Table">
					<div id="row_invoice">
						...
						<div id="row_invoice_c">
							...
							<div id="ID9_15_2020_df">
								<span>9/15/2020</span>
							</div>
						</div>
						<div id="row_invoice_dg">
							<svg class="Divider_dh">
								<rect fill="rgba(241,241,243,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Divider_dh" rx="0" ry="0" x="0" y="0" width="1078.96" height="1">
								</rect>
							</svg>
							<svg class="Row_BG_di" viewBox="0 0 1078.96 50">
								<path fill="rgba(255,255,255,1)" id="Row_BG_di" d="M 0 0 L 794.535400390625 0 L 1078.96044921875 0 L 1078.96044921875 50 L 0 50 L 0 0 Z">
								</path>
							</svg>
						...
						<div id="row_invoice_dr">
							<svg class="Divider_ds">
								<rect fill="rgba(241,241,243,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Divider_ds" rx="0" ry="0" x="0" y="0" width="1078.96" height="1">
								</rect>
							</svg>
							<svg class="Row_BG_dt" viewBox="0 0 1078.96 50">
								<path fill="rgba(255,255,255,1)" id="Row_BG_dt" d="M 0 0 L 794.535400390625 0 L 1078.96044921875 0 L 1078.96044921875 50 L 0 50 L 0 0 Z">
								</path>
							</svg>
	...
	<div id="Group_325">
		<svg class="Rectangle_1497_eq">
			<rect fill="rgba(255,255,255,1)" stroke="rgba(112,112,112,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_1497_eq" rx="10" ry="10" x="0" y="0" width="858" height="490">
			</rect>
		</svg>
		<div id="Create_Issue">
			<span>Create Issue</span>
		</div>
		<svg class="Line_41_es" viewBox="0 0 857.5 1">
			<path fill="transparent" id="Line_41_es" d="M 0 0 L 857.5 0">
			</path>
		</svg>
		<div id="Group_303">
			<div id="Group_193_eu">
				<svg class="Rectangle_1489_ev">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ev" rx="5" ry="5" x="0" y="0" width="182" height="42">
					</rect>
				</svg>
				<div id="Expected_End">
		...
		<div id="Group_315">
			<div id="Group_193_ey">
				<svg class="Rectangle_1489_ez">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_ez" rx="5" ry="5" x="0" y="0" width="182" height="42">
					</rect>
				</svg>
		...
		<div id="Group_316">
			<div id="Group_193_e">
				<svg class="Rectangle_1489_e">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_e" rx="5" ry="5" x="0" y="0" width="182" height="42">
					</rect>
				</svg>
				<div id="Priority_e">
					<span>Priority</span>
		...
		<div id="Group_301">
			<div id="Group_198">
				<svg class="Rectangle_1489_fa">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_fa" rx="5" ry="5" x="0" y="0" width="788" height="100">
					</rect>
				</svg>
		...
		<svg class="Rectangle_1489_fb">
			<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_fb" rx="5" ry="5" x="0" y="0" width="783" height="44">
			</rect>
		</svg>
		<div id="Group_22">
		...
		<div id="Group_193_fg">
			<svg class="Rectangle_1489_fh">
				<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_fh" rx="5" ry="5" x="0" y="0" width="320" height="42">
				</rect>
			</svg>
		...
		<div id="Group_326">
			<div id="Group_193_fl">
				<svg class="Rectangle_1489_fm">
					<rect fill="rgba(247,250,252,1)" id="Rectangle_1489_fm" rx="5" ry="5" x="0" y="0" width="182" height="42">
					</rect>
				</svg>
				<div id="Severity_fn">
					<span>Severity</span>
